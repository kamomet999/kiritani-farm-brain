...
- 作業指示は **ハウス号数** で場所を特定（例:「OZ03 で誘引」「垣内下 KA15–22 全棟 収穫」）。
- 号数は「エリア記号＋連番」で一意（例: OZ03、KA17）。記号でエリアが即分かり、そのまま進捗・写真・ダッシュボードのキーになる。
